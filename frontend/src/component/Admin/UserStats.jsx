...
import { Calculate_Suspended_User, Calculate_Verified_User } from "../../redux/features/auth/authSlice";
...
const UserStats = () => {
  ...
  useEffect(() =>{
    dispatch(Calculate_Verified_User())
    dispatch(Calculate_Suspended_User())
  }, [dispatch, users]);
